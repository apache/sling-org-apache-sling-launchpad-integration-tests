...
public class PostSendErrorTest extends HttpTestBase {
    ...
    public void testNotSuccessfulWithHtmlResponseAndSendError() throws IOException {
        ...
        String content = getContent(
                ...
                CONTENT_TYPE_HTML,
                Arrays.asList(
                        new NameValuePair(SlingPostConstants.RP_SEND_ERROR, "true"),
        ...
        Pattern regex = Pattern.compile(
                "The requested URL \\/PostSendErrorTest\\/.* resulted in an error in org.apache.sling.servlets.post.impl.SlingPostServlet\\.",
                Pattern.MULTILINE);
