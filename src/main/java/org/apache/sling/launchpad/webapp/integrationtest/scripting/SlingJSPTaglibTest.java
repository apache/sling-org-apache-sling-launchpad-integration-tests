...
public class SlingJSPTaglibTest extends RenderingTestBase {
    ...
    protected void setUp() throws Exception {
        ...
        testPage = testClient.createNode(testRootPath + SlingPostConstants.DEFAULT_CREATE_SUFFIX, props);

        log.info("Creating testing component...");
        testClient.mkdirs(HTTP_BASE_URL, "/apps/integration-test/taglib-test");
        testClient.upload(
                HTTP_BASE_URL + "/apps/integration-test/taglib-test/taglib-test.jsp",
                SlingJSPTaglibTest.class.getClassLoader().getResourceAsStream("integration-test/taglib-test.jsp"));
