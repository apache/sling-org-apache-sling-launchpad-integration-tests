...
public class PostServletOutputContentTypeTest extends HttpTestBase {
    ...
    public void testHtmlContentTypeWithQ() throws Exception {
        runTest(
                "text/plain; q=0.5, text/html,application/xhtml+xml,application/xml;q=0.9, application/json;q=0.8",
                CONTENT_TYPE_HTML);
    }
    ...
    public void testJsonContentTypeException() throws Exception {
        ...
        assertTrue(
                "Expecting content-type " + expected + " for failed POST request, got " + contentType,
