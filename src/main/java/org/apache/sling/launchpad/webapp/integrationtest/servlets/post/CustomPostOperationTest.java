...
public class CustomPostOperationTest extends HttpTestBase {
    ...
    protected void setUp() throws Exception {
        ...
        final String testPath =
                "/" + getClass().getSimpleName() + counter.incrementAndGet() + "_" + System.currentTimeMillis();
    ...
    private void assertCustomPostOperation(String operationName, String markerPropertyName) throws Exception {
        ...
        assertFalse(
                "Expecting no marker before POST",
        ...
        assertTrue(
                "Expecting marker to be present after POST",
                getContent(jsonPath, CONTENT_TYPE_JSON).contains(markerPropertyName));
    }

    public void testCustomPostOperation() throws Exception {
        assertCustomPostOperation(
                "test:SlingPostOperationExample",
    ...
    public void testOldStyleCustomPostOperation() throws Exception {
        assertCustomPostOperation(
                "test:OldStylePostOperationExample",
